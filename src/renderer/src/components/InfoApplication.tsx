...
export const InfoApplication = () => {
  ...
  return (
    ...
    <div className="w-auto h-64 flex flex-col justify-center items-start gap-2">
      <button className='px-2 py-1 rounded-md border-zinc-400/10 hover:bg-zinc-600/20 transition-colors duration-100 w-full flex flex-row' onClick={() => OpenUrl('https://tailwindcss.com/docs/margin')}>
      ...
      <button className='px-2 py-1 rounded-md border-zinc-400/10 hover:bg-zinc-600/20 transition-colors duration-100 w-full flex flex-row'>
